...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        {
            var celetialObject = _context.CelestialObjects.Find(id);
            if (celetialObject == null)
                return NotFound();
            celetialObject.Satellites = _context.CelestialObjects.Where(e => e.OrbitedObjectId == id).ToList();
            return Ok(celetialObject);
        }
